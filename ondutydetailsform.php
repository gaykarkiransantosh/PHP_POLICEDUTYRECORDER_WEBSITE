...
<span class="word">Enter Your On Duty Address:</span><input type="text" name="add" placeholder="       Enter Address">
<span class="word">Enter Your Mobile No:</span><input type="text" name="mobile" placeholder="       Enter Mobile no">
<span class="word">Enter Time:</span><input type="time" name="time" placeholder="       Enter Time">
<span class="word">Attached Picture:</span>  <input type="file" name="profileImage"  id="profileImage" >
<?php if(!empty($msg)):?>
...
<?php
  ...
  $sql="INSERT INTO ondutydetails(Name ,Address,Contact,Image) VALUES('$name','$aadd1','$mobile1','$image1')";
